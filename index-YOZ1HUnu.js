var le=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var c=(e,t,s)=>new Promise((r,o)=>{var n=u=>{try{d(s.next(u))}catch(v){o(v)}},i=u=>{try{d(s.throw(u))}catch(v){o(v)}},d=u=>u.done?r(u.value):Promise.resolve(u.value).then(n,i);d((s=s.apply(e,t)).next())});import{a as de}from"./api-CGQni89X.js";import{i as l}from"./toast-CnhFlkt1.js";import{S as X,N as Y,P as J}from"./swiper-BdJhUY6v.js";import"./accordion-n9T1KWKK.js";/* empty css               */var Je=le(q=>{(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function s(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(o){if(o.ep)return;o.ep=!0;const n=s(o);fetch(o.href,n)}})();const ue="https://furniture-store.b.goit.study/api",S={FURNITURES:"/furnitures",CATEGORIES:"/categories",ORDERS:"/orders",FEEDBACKS:"/feedbacks"},M=de.create({baseURL:ue,headers:{"Content-Type":"application/json"}});function y(e=1,t=10,s){return c(this,null,function*(){try{return(yield M.get(S.FURNITURES,{params:{page:e,limit:t,category:s}})).data}catch(r){return l.error({title:"Помилка",message:"Не вдалося завантажити меблі. Спробуйте пізніше.",position:"topRight",timeout:4e3}),null}})}function pe(e){return c(this,null,function*(){try{let t=1;const s=30;let r=0,o=0;do{const i=(yield M.get(S.FURNITURES,{params:{page:t,limit:s}})).data,d=i.furnitures||i;t===1&&(r=i.totalItems||0,o=Math.ceil(r/s));const u=d.find(v=>v._id===e);if(u)return u;t++}while(t<=o);return l.warning({title:"Увага",message:"Товар з таким ID не знайдено.",position:"topRight",timeout:4e3}),null}catch(t){return l.error({title:"Помилка",message:"Не вдалося завантажити інформацію про товар.",position:"topRight",timeout:4e3}),null}})}function me(){return c(this,null,function*(){try{return(yield M.get(S.CATEGORIES)).data}catch(e){return l.error({title:"Помилка",message:"Не вдалося завантажити категорії. Перевірте підключення до інтернету.",position:"topRight",timeout:4e3}),null}})}function ge(e=1,t=10){return c(this,null,function*(){try{return(yield M.get(S.FEEDBACKS,{params:{page:e,limit:t}})).data}catch(s){return l.error({title:"Помилка",message:"Не вдалося завантажити відгуки. Спробуйте оновити сторінку.",position:"topRight",timeout:4e3}),null}})}function fe(e){return c(this,null,function*(){try{const t=yield M.post(S.ORDERS,e);return l.success({title:"Успіх!",message:"Замовлення успішно створено. Ми зв'яжемося з вами найближчим часом.",position:"topRight",timeout:4e3}),t.data}catch(t){return l.error({title:"Помилка замовлення",message:"Не вдалося створити замовлення. Перевірте дані та спробуйте ще раз.",position:"topRight",timeout:4e3}),null}})}function he(){return c(this,null,function*(){try{return(yield M.get(S.FURNITURES,{params:{type:"popular"}})).data}catch(e){return l.error({title:"Помилка",message:"Не вдалося завантажити популярні товари. Спробуйте пізніше.",position:"topRight",timeout:4e3}),null}})}(()=>{const e=document.querySelector(".js-menu-container"),t=document.querySelector(".js-open-menu"),s=t.querySelector("use"),r=e.querySelectorAll(".nav-link, .mobile-order-btn");let o=null,n=null;const i=()=>s.getAttribute("href").split("#")[0],d=()=>p=>{p.key==="Escape"&&k()},u=()=>p=>{const ae=e.contains(p.target),ce=t.contains(p.target);!ae&&!ce&&k()},v=()=>{o||(o=d()),n||(n=u()),document.addEventListener("keydown",o),document.addEventListener("click",n)},U=()=>{o&&document.removeEventListener("keydown",o),n&&document.removeEventListener("click",n)},k=()=>{const p=i();e.classList.remove("is-open"),t.setAttribute("aria-expanded",!1),s.setAttribute("href",`${p}#icon-burger`),t.setAttribute("aria-label","Перемикач мобільного меню"),document.body.classList.remove("no-scroll"),U()},ne=()=>{const p=i();e.classList.add("is-open"),t.setAttribute("aria-expanded",!0),s.setAttribute("href",`${p}#icon-close`),t.setAttribute("aria-label","Закрити мобільне меню"),document.body.classList.add("no-scroll"),v()},ie=()=>{e.classList.contains("is-open")?k():ne()};t.addEventListener("click",ie),r.forEach(p=>{p.addEventListener("click",()=>{e.classList.contains("is-open")&&k()})});const z=window.matchMedia("(min-width: 1440px)"),W=p=>{p.matches&&e.classList.contains("is-open")&&k()};z.addEventListener("change",W),window.addEventListener("beforeunload",()=>{U(),z.removeEventListener("change",W)})})();const Q=document.querySelector(".product-categories-list"),g=document.querySelector(".pagination"),R=document.querySelector(".btn-loadMore"),ee="Всі товари";let a=1,f=1,L=null;function ve(){const e=document.querySelector(".product-categories-content");e&&e.classList.add("active-category")}function ye(e){e.target.closest(".product-categories-content").classList.add("active-category")}function we(){const e=document.querySelector(".active-category");e&&e.classList.remove("active-category")}function be(e){const t=e.map((s,r)=>`<li class="product-categories-item" data-id="${s._id}">
  ...
  <div class="product-categories-content">
...
</li>`).join("");Q.innerHTML=t}function Le(){return c(this,null,function*(){try{const e=yield me();be([{name:ee,_id:"78fa12bc34de56f7890a1b35"},...e]),ve()}catch(e){return[]}})}function Ee(e){const t=e.target.closest(".product-categories-item");if(!t)return;const s=t.textContent.trim(),r=t.dataset.id;a=1,we(),ye(e),s===ee?(L=null,w(y(1,8))):(L=r,w(y(1,8,r)))}Q.addEventListener("click",Ee);function Se(e=8){const t=document.querySelector(".products-list");t.innerHTML="";for(let s=0;s<e;s++){const r=document.createElement("div");r.className="product-item skeleton",r.innerHTML=`
    ...
    `,t.appendChild(r)}}function w(){return c(this,arguments,function*(e=y(a,8)){const t=document.querySelector(".products-list"),s=window.matchMedia("(max-width: 767px)").matches,r=t.querySelectorAll(".product-item").length;(!s||a===1)&&Se(8),ke();try{const o=yield e,n=o.furnitures||o;if(f=Math.ceil(o.totalItems/8),s&&a>1){n.forEach(d=>{t.appendChild(j(d))});const i=t.querySelectorAll(".product-item")[r];i&&i.scrollIntoView({behavior:"smooth",block:"start"})}else t.innerHTML="",n.forEach(i=>{t.appendChild(j(i))});s?te():(Me(a),xe())}catch(o){t.innerHTML="<p>Помилка завантаження товарів.</p>"}finally{$e()}})}function j(e){const t=document.createElement("li");return t.className="product-item",t.setAttribute("data-id",e._id),t.innerHTML=`
  ...
  `}function ke(){document.querySelector(".loader").classList.remove("visuallyhidden")}function $e(){document.querySelector(".loader").classList.add("visuallyhidden")}function xe(){const e=document.querySelector(".btn-prev"),t=document.querySelector(".btn-next");a===1?e.classList.add("disabled"):e.classList.remove("disabled"),a>=f?t.classList.add("disabled"):t.classList.remove("disabled")}function te(){a>=f?R.style.display="none":R.style.display="inline"}document.addEventListener("click",e=>c(q,null,function*(){if(e.target.closest(".page-number")){const t=e.target.closest(".page-number"),s=parseInt(t.textContent,10);isNaN(s)||(a=s,yield w(y(a,8,L)))}e.target.closest(".btn-next")&&a<f&&(a++,yield w(y(a,8,L))),e.target.closest(".btn-prev")&&a>1&&(a--,yield w(y(a,8,L)))}));R.addEventListener("click",()=>c(q,null,function*(){a<f&&(a++,te(),yield w(y(a,8,L)))}));document.addEventListener("DOMContentLoaded",()=>{Le(),w()});class Ce{constructor(){this.swiperContainer=document.querySelector(".popular-products-swiper"),this.swiperWrapper=document.querySelector(".popular-products-swiper .swiper-wrapper"),this.loader=document.querySelector(".popular-products-loader"),this.swiper=null,this.products=[],this.init()}init(){return c(this,null,function*(){yield this.loadProducts(),this.products.length>=3&&(this.renderProducts(),this.initSwiper())})}loadProducts(){return c(this,null,function*(){this.showLoader();try{const t=yield he();t&&t.furnitures&&t.furnitures.length>=3?this.products=t.furnitures:this.showError("Недостатньо популярних товарів для відображення")}catch(t){this.showError("Помилка завантаження популярних товарів")}finally{this.hideLoader()}})}renderProducts(){const t=this.products.map(s=>`
    ...
    `).join("");t.innerHTML=s}function Pe(){try{if(!document.querySelector(".reviews .swiper")){l.error({title:"Помилка",message:"Елемент слайдера відгуків не знайдено.",position:"topRight",timeout:4e3});return}const t=new X(".reviews .swiper",{modules:[Y,J],slidesPerView:1,spaceBetween:20,loop:!1,navigation:{nextEl:".reviews .swiper-button-next",prevEl:".reviews .swiper-button-prev"},pagination:{el:".reviews .swiper-pagination",clickable:!0},breakpoints:{768:{slidesPerView:2,spaceBetween:20},1440:{slidesPerView:3,spaceBetween:20}},on:{init:function(){V(this)},slideChange:function(){V(this)}}})}catch(e){l.error({title:"Помилка",message:"Не вдалося ініціалізувати слайдер відгуків.",position:"topRight",timeout:4e3})}}function V(e){const t=document.querySelector(".reviews .swiper-button-prev"),s=document.querySelector(".reviews .swiper-button-next");t&&t.classList.toggle("swiper-button-disabled",e.isBeginning),s&&s.classList.toggle("swiper-button-disabled",e.isEnd)}const Re=/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/,Te=/^[0-9]{12}$/;let $=null,x=null,P=null,T=null,A=null,m=null,h=null,se=null;function b(e){return(e||"").replace(/\D/g,"")}function _(e){let t=b(e);t.startsWith("38")||(t="38"+t),t=t.slice(0,12);const s=t.slice(2);let r="+38";return s.length>0&&(r+=" ("+s.slice(0,Math.min(3,s.length))),s.length>=3&&(r+=")"),s.length>3&&(r+=" "+s.slice(3,Math.min(6,s.length))),s.length>6&&(r+=" "+s.slice(6,Math.min(8,s.length))),s.length>8&&(r+=" "+s.slice(8,Math.min(10,s.length))),r}function Ae(e){e&&(b(e.value)?e.value=_(e.value):e.value="+38 ",e.addEventListener("input",()=>{const t=b(e.value);e.value=_(t)}),e.addEventListener("focus",()=>{b(e.value)||(e.value="+38 ")}),e.addEventListener("blur",()=>{(e.value.trim()==="+38"||e.value.trim()==="+38("||b(e.value)==="38")&&(e.value="")}))}const Oe=()=>e=>{e.key==="Escape"&&I()},Be=()=>e=>{(e.target===m||e.target===se)&&I()},De=()=>{$||($=Oe()),x||(x=Be()),document.addEventListener("keydown",$),m&&m.addEventListener("click",x)},Ne=()=>{$&&document.removeEventListener("keydown",$),x&&m&&m.removeEventListener("click",x)};function oe(){m=document.getElementById("order-backdrop"),h=document.querySelector(".order-form"),se=document.querySelector(".close-btn")}function Fe(e,t){m||oe(),m&&(m.classList.remove("visuallyhidden"),document.body.style.overflow="hidden",T=e,A=t,De())}const I=()=>{m&&(m.classList.add("visuallyhidden"),document.body.style.overflow=""),h&&h.reset(),Ne()};function Ue(e){return c(this,null,function*(){e.preventDefault();const t=new FormData(h),s=Object.fromEntries(t),r=h.querySelector(".submit-btn");let o=!0;Re.test(s.email)||(l.error({title:"Validation Error",message:"Please enter a valid E-mail address.",position:"topRight"}),o=!1);const n=b(s.phone);if(Te.test(n)||(l.error({title:"Validation Error",message:"Please enter a valid phone number (12 digits).",position:"topRight"}),o=!1),s.phone=n,(!s.comment||s.comment.trim().length<3)&&(l.error({title:"Validation Error",message:"Please enter a comment with at least 3 characters.",position:"topRight"}),o=!1),(!T||!A)&&(l.error({title:"Error",message:"Could not get furniture details. Please try again.",position:"topRight"}),o=!1),!o){r&&(r.disabled=!1);return}r&&(r.disabled=!0);const i={email:s.email,phone:s.phone,comment:s.comment,modelId:T,color:A};try{(yield fe(i))&&I()}catch(d){}finally{r&&(r.disabled=!1)}})}function K(){if(oe(),h){P||(P=Ue),h.addEventListener("submit",P);const t=h.querySelector('input[name="phone"]');Ae(t)}const e=document.querySelector(".close-btn");e&&e.addEventListener("click",I)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",K):K();const re="/project-nobug-nocry/images/sprite-CTbW2Ani.svg",E=document.querySelector(".modal-window"),G=document.querySelector(".products-list");let O=0,B="",C=null,H=null,D=[];function ze(e){return e>=3.3&&e<=3.7?3.5:e>=3.8&&e<=4.2?4:Math.round(e*2)/2}function We(e){const t=ze(e),s=Math.floor(t),r=t%1!==0,o=5-Math.ceil(t);let n="";for(let i=0;i<s;i++)n+='<span class="star star-full">★</span>';r&&(n+='<span class="star star-half">★</span>');for(let i=0;i<o;i++)n+='<span class="star star-empty">★</span>';return`<div class="modal-rating-stars" data-rating="${t}">${n}</div>`}const je=()=>e=>{e.key==="Escape"&&N()},Ve=()=>e=>{const t=e.target.closest(".product-modalWindow"),s=e.target.closest(".modal-close-btn");(!t||s)&&N()},_e=()=>{C||(C=je()),H||(H=Ve()),document.addEventListener("keydown",C),E.addEventListener("click",H)},Ke=()=>{C&&document.removeEventListener("keydown",C),H&&E.removeEventListener("click",H),D.forEach(({input:e,handler:t})=>{e.removeEventListener("change",t)}),D=[]};function N(){E.classList.add("visuallyhidden"),document.body.style.overflow="",Ke()}function Ge(){const e=document.querySelector(".modalButton");e&&e.addEventListener("click",function(){N(),Fe(O,B)})}function Ze(){return`
  ...
  </div>`}function F(e){return c(this,null,function*(){document.body.style.overflow="hidden",E.classList.remove("visuallyhidden"),E.innerHTML=Ze(),_e(),O=e;const t=yield pe(O),s=Ye(t);E.innerHTML=s;const r=document.querySelectorAll('input[name="furniture-color"]');r.length>0&&(r[0].checked=!0,B=r[0].value),r.forEach(o=>{const n=function(){B=this.value};o.addEventListener("change",n),D.push({input:o,handler:n})}),Ge(),Xe()})}function Xe(){const e=document.querySelector(".modal-image-0"),t=document.querySelector(".modal-image-1"),s=document.querySelector(".modal-image-2");if(!e||!t||!s)return;function r(o,n){o.style.opacity="0.5",setTimeout(()=>{const i=o.src,d=o.alt;o.src=n.src,o.alt=n.alt,n.src=i,n.alt=d,o.style.opacity="1"},150)}t.addEventListener("click",()=>r(e,t)),s.addEventListener("click",()=>r(e,s))}document.addEventListener("openProductModal",function(e){const t=e.detail.productId;F(t)});G&&G.addEventListener("click",function(e){return c(this,null,function*(){if(e.target.matches("img, button")){const t=e.target.closest(".product-item");if(t){const s=t.getAttribute("data-id");yield F(s)}}})});const Z=document.querySelector(".popular-products-swiper");Z&&Z.addEventListener("click",function(e){return c(this,null,function*(){if(e.target.matches("img.img-card, button.btn-go-modal")){const t=e.target.closest(".popular-products-item");if(t){const s=t.getAttribute("data-id");yield F(s)}}})});function Ye(e){return`
  <div class="product-modalWindow">

var le=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var c=(e,t,s)=>new Promise((o,r)=>{var n=d=>{try{p(s.next(d))}catch(v){r(v)}},i=d=>{try{p(s.throw(d))}catch(v){r(v)}},p=d=>d.done?o(d.value):Promise.resolve(d.value).then(n,i);p((s=s.apply(e,t)).next())});import{a as de}from"./api-CGQni89X.js";import{i as l}from"./toast-CnhFlkt1.js";import{S as Z,N as X,P as Y}from"./swiper-BdJhUY6v.js";import"./accordion-n9T1KWKK.js";/* empty css               */var Ye=le(q=>{(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const ue="https://furniture-store.b.goit.study/api",E={FURNITURES:"/furnitures",CATEGORIES:"/categories",ORDERS:"/orders",FEEDBACKS:"/feedbacks"},S=de.create({baseURL:ue,headers:{"Content-Type":"application/json"}});function y(e=1,t=10,s){return c(this,null,function*(){try{return(yield S.get(E.FURNITURES,{params:{page:e,limit:t,category:s}})).data}catch(o){return l.error({title:"Помилка",message:"Не вдалося завантажити меблі. Спробуйте пізніше.",position:"topRight",timeout:4e3}),null}})}function pe(e){return c(this,null,function*(){try{let t=1;const s=30;let o=0,r=0;do{const i=(yield S.get(E.FURNITURES,{params:{page:t,limit:s}})).data,p=i.furnitures||i;t===1&&(o=i.totalItems||0,r=Math.ceil(o/s));const d=p.find(v=>v._id===e);if(d)return d;t++}while(t<=r);return l.warning({title:"Увага",message:"Товар з таким ID не знайдено.",position:"topRight",timeout:4e3}),null}catch(t){return l.error({title:"Помилка",message:"Не вдалося завантажити інформацію про товар.",position:"topRight",timeout:4e3}),null}})}function me(){return c(this,null,function*(){try{return(yield S.get(E.CATEGORIES)).data}catch(e){return l.error({title:"Помилка",message:"Не вдалося завантажити категорії. Перевірте підключення до інтернету.",position:"topRight",timeout:4e3}),null}})}function ge(e=1,t=10){return c(this,null,function*(){try{return(yield S.get(E.FEEDBACKS,{params:{page:e,limit:t}})).data}catch(s){return l.error({title:"Помилка",message:"Не вдалося завантажити відгуки. Спробуйте оновити сторінку.",position:"topRight",timeout:4e3}),null}})}function fe(e){return c(this,null,function*(){try{const t=yield S.post(E.ORDERS,e);return l.success({title:"Успіх!",message:"Замовлення успішно створено. Ми зв'яжемося з вами найближчим часом.",position:"topRight",timeout:4e3}),t.data}catch(t){return l.error({title:"Помилка замовлення",message:"Не вдалося створити замовлення. Перевірте дані та спробуйте ще раз.",position:"topRight",timeout:4e3}),null}})}function he(){return c(this,null,function*(){try{return(yield S.get(E.FURNITURES,{params:{type:"popular"}})).data}catch(e){return l.error({title:"Помилка",message:"Не вдалося завантажити популярні товари. Спробуйте пізніше.",position:"topRight",timeout:4e3}),null}})}(()=>{const e=document.querySelector(".js-menu-container"),t=document.querySelector(".js-open-menu"),s=t.querySelector("use"),o=e.querySelectorAll(".nav-link, .mobile-order-btn");let r=null,n=null;const i=()=>s.getAttribute("href").split("#")[0],p=()=>u=>{u.key==="Escape"&&M()},d=()=>u=>{const ae=e.contains(u.target),ce=t.contains(u.target);!ae&&!ce&&M()},v=()=>{r||(r=p()),n||(n=d()),document.addEventListener("keydown",r),document.addEventListener("click",n)},N=()=>{r&&document.removeEventListener("keydown",r),n&&document.removeEventListener("click",n)},M=()=>{const u=i();e.classList.remove("is-open"),t.setAttribute("aria-expanded",!1),s.setAttribute("href",`${u}#icon-burger`),t.setAttribute("aria-label","Перемикач мобільного меню"),document.body.classList.remove("no-scroll"),N()},ne=()=>{const u=i();e.classList.add("is-open"),t.setAttribute("aria-expanded",!0),s.setAttribute("href",`${u}#icon-close`),t.setAttribute("aria-label","Закрити мобільне меню"),document.body.classList.add("no-scroll"),v()},ie=()=>{e.classList.contains("is-open")?M():ne()};t.addEventListener("click",ie),o.forEach(u=>{u.addEventListener("click",()=>{e.classList.contains("is-open")&&M()})});const F=window.matchMedia("(min-width: 1440px)"),U=u=>{u.matches&&e.classList.contains("is-open")&&M()};F.addEventListener("change",U),window.addEventListener("beforeunload",()=>{N(),F.removeEventListener("change",U)})})();const J=document.querySelector(".product-categories-list"),g=document.querySelector(".pagination"),R=document.querySelector(".btn-loadMore"),Q="Всі товари";let a=1,f=1,L=null;function ve(){const e=document.querySelector(".product-categories-content");e&&e.classList.add("active-category")}function ye(e){e.target.closest(".product-categories-content").classList.add("active-category")}function we(){const e=document.querySelector(".active-category");e&&e.classList.remove("active-category")}function be(e){const t=e.map((s,o)=>`<li class="product-categories-item" data-id="${s._id}">
  <img
  ...
  <div class="product-categories-content">
...
</li>`).join("");J.innerHTML=t}function Le(){return c(this,null,function*(){try{const e=yield me();be([{name:Q,_id:"78fa12bc34de56f7890a1b35"},...e]),ve()}catch(e){return[]}})}function Ee(e){const t=e.target.closest(".product-categories-item");if(!t)return;const s=t.textContent.trim(),o=t.dataset.id;a=1,we(),ye(e),s===Q?(L=null,w(y(1,8))):(L=o,w(y(1,8,o)))}J.addEventListener("click",Ee);function Se(e=8){const t=document.querySelector(".products-list");t.innerHTML="";for(let s=0;s<e;s++){const o=document.createElement("div");o.className="product-item skeleton",o.innerHTML=`
    ...
    `,t.appendChild(o)}}function w(){return c(this,arguments,function*(e=y(a,8)){const t=document.querySelector(".products-list"),s=window.matchMedia("(max-width: 767px)").matches,o=t.querySelectorAll(".product-item").length;(!s||a===1)&&Se(8),ke();try{const r=yield e,n=r.furnitures||r;if(f=Math.ceil(r.totalItems/8),s&&a>1){n.forEach(p=>{t.appendChild(z(p))});const i=t.querySelectorAll(".product-item")[o];i&&i.scrollIntoView({behavior:"smooth",block:"start"})}else t.innerHTML="",n.forEach(i=>{t.appendChild(z(i))});s?ee():(Me(a),xe())}catch(r){t.innerHTML="<p>Помилка завантаження товарів.</p>"}finally{$e()}})}function z(e){const t=document.createElement("li");return t.className="product-item",t.setAttribute("data-id",e._id),t.innerHTML=`
  ...
  `}function ke(){document.querySelector(".loader").classList.remove("visuallyhidden")}function $e(){document.querySelector(".loader").classList.add("visuallyhidden")}function xe(){const e=document.querySelector(".btn-prev"),t=document.querySelector(".btn-next");a===1?e.classList.add("disabled"):e.classList.remove("disabled"),a>=f?t.classList.add("disabled"):t.classList.remove("disabled")}function ee(){a>=f?R.style.display="none":R.style.display="inline"}document.addEventListener("click",e=>c(q,null,function*(){if(e.target.closest(".page-number")){const t=e.target.closest(".page-number"),s=parseInt(t.textContent,10);isNaN(s)||(a=s,yield w(y(a,8,L)))}e.target.closest(".btn-next")&&a<f&&(a++,yield w(y(a,8,L))),e.target.closest(".btn-prev")&&a>1&&(a--,yield w(y(a,8,L)))}));R.addEventListener("click",()=>c(q,null,function*(){a<f&&(a++,ee(),yield w(y(a,8,L)))}));document.addEventListener("DOMContentLoaded",()=>{Le(),w()});class Ce{constructor(){this.swiperContainer=document.querySelector(".popular-products-swiper"),this.swiperWrapper=document.querySelector(".popular-products-swiper .swiper-wrapper"),this.loader=document.querySelector(".popular-products-loader"),this.swiper=null,this.products=[],this.init()}init(){return c(this,null,function*(){yield this.loadProducts(),this.products.length>=3&&(this.renderProducts(),this.initSwiper())})}loadProducts(){return c(this,null,function*(){this.showLoader();try{const t=yield he();t&&t.furnitures&&t.furnitures.length>=3?this.products=t.furnitures:this.showError("Недостатньо популярних товарів для відображення")}catch(t){this.showError("Помилка завантаження популярних товарів")}finally{this.hideLoader()}})}renderProducts(){const t=this.products.map(s=>`
    ...
    `).join("");t.innerHTML=s}function Pe(){try{if(!document.querySelector(".reviews .swiper")){l.error({title:"Помилка",message:"Елемент слайдера відгуків не знайдено.",position:"topRight",timeout:4e3});return}const t=new Z(".reviews .swiper",{modules:[X,Y],slidesPerView:1,spaceBetween:20,loop:!1,navigation:{nextEl:".reviews .swiper-button-next",prevEl:".reviews .swiper-button-prev"},pagination:{el:".reviews .swiper-pagination",clickable:!0},breakpoints:{768:{slidesPerView:2,spaceBetween:20},1440:{slidesPerView:3,spaceBetween:20}},on:{init:function(){W(this)},slideChange:function(){W(this)}}})}catch(e){l.error({title:"Помилка",message:"Не вдалося ініціалізувати слайдер відгуків.",position:"topRight",timeout:4e3})}}function W(e){const t=document.querySelector(".reviews .swiper-button-prev"),s=document.querySelector(".reviews .swiper-button-next");t&&t.classList.toggle("swiper-button-disabled",e.isBeginning),s&&s.classList.toggle("swiper-button-disabled",e.isEnd)}const Re=/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/,Ae=/^[0-9]{12}$/;let k=null,$=null,P=null;function b(e){return(e||"").replace(/\D/g,"")}function _(e){let t=b(e);t.startsWith("38")||(t="38"+t),t=t.slice(0,12);const s=t.slice(2);let o="+38";return s.length>0&&(o+=" ("+s.slice(0,Math.min(3,s.length))),s.length>=3&&(o+=")"),s.length>3&&(o+=" "+s.slice(3,Math.min(6,s.length))),s.length>6&&(o+=" "+s.slice(6,Math.min(8,s.length))),s.length>8&&(o+=" "+s.slice(8,Math.min(10,s.length))),o}function Be(e){e&&(b(e.value)?e.value=_(e.value):e.value="+38 ",e.addEventListener("input",()=>{const t=b(e.value);e.value=_(t)}),e.addEventListener("focus",()=>{b(e.value)||(e.value="+38 ")}),e.addEventListener("blur",()=>{(e.value.trim()==="+38"||e.value.trim()==="+38("||b(e.value)==="38")&&(e.value="")}))}let te=null,se=null,m=null,h=null,oe=null;const Oe=()=>e=>{e.key==="Escape"&&I()},Te=()=>e=>{(e.target===m||e.target===oe)&&I()},De=()=>{k||(k=Oe()),$||($=Te()),document.addEventListener("keydown",k),m&&m.addEventListener("click",$)},Ne=()=>{k&&document.removeEventListener("keydown",k),$&&m&&m.removeEventListener("click",$)};function re(){m=document.getElementById("order-backdrop"),h=document.querySelector(".order-form"),oe=document.querySelector(".close-btn")}function Fe(e,t){m||re(),m&&(m.classList.remove("visuallyhidden"),document.body.style.overflow="hidden",te=e,se=t,De())}const I=()=>{m&&(m.classList.add("visuallyhidden"),document.body.style.overflow=""),h&&h.reset(),Ne()};function Ue(e){return c(this,null,function*(){e.preventDefault();const t=new FormData(h),s=Object.fromEntries(t),o=h.querySelector(".submit-btn");if(o&&(o.disabled=!0),s.modelId=te,s.color=se,!Re.test(s.email)){l.error({title:"Validation Error",message:"Please enter a valid E-mail address.",position:"topRight"}),o&&(o.disabled=!1);return}const r=b(s.phone);if(!Ae.test(r)){l.error({title:"Validation Error",message:"Please enter a valid phone like +38 (099) 123 22 11. Digits-only: 12 (e.g., 380991232211).",position:"topRight"}),o&&(o.disabled=!1);return}if(s.phone=r,!s.modelId||!s.color){l.error({title:"Error",message:"Could not get furniture details. Please try again.",position:"topRight"}),o&&(o.disabled=!1);return}try{(yield fe(s))&&I()}catch(n){}finally{o&&(o.disabled=!1)}})}function j(){if(re(),h){P||(P=Ue),h.addEventListener("submit",P);const e=h.querySelector('input[name="phone"]');Be(e)}}const V=document.querySelector(".close-btn");V&&V.addEventListener("click",I);document.readyState==="loading"?document.addEventListener("DOMContentLoaded",j):j();const ze="/project-nobug-nocry/images/sprite-CTbW2Ani.svg",H=document.querySelector(".modal-window"),K=document.querySelector(".products-list");let A=0,B="",x=null,C=null,O=[];function We(e){return e>=3.3&&e<=3.7?3.5:e>=3.8&&e<=4.2?4:Math.round(e*2)/2}function _e(e){const t=We(e),s=Math.floor(t),o=t%1!==0,r=5-Math.ceil(t);let n="";for(let i=0;i<s;i++)n+='<span class="star star-full">★</span>';o&&(n+='<span class="star star-half">★</span>');for(let i=0;i<r;i++)n+='<span class="star star-empty">★</span>';return`<div class="modal-rating-stars" data-rating="${t}">${n}</div>`}const je=()=>e=>{e.key==="Escape"&&T()},Ve=()=>e=>{const t=e.target.closest(".product-modalWindow"),s=e.target.closest(".modal-close-btn");(!t||s)&&T()},Ke=()=>{x||(x=je()),C||(C=Ve()),document.addEventListener("keydown",x),H.addEventListener("click",C)},Ge=()=>{x&&document.removeEventListener("keydown",x),C&&H.removeEventListener("click",C),O.forEach(({input:e,handler:t})=>{e.removeEventListener("change",t)}),O=[]};function T(){H.classList.add("visuallyhidden"),document.body.style.overflow="",Ge()}function Ze(){const e=document.querySelector(".modalButton");e&&e.addEventListener("click",function(){T(),Fe(A,B)})}function D(e){return c(this,null,function*(){document.body.style.overflow="hidden",H.classList.remove("visuallyhidden"),A=e;const t=yield pe(A),s=Xe(t);H.innerHTML=s;const o=document.querySelectorAll('input[name="furniture-color"]');o.length>0&&(o[0].checked=!0,B=o[0].value),o.forEach(r=>{const n=function(){B=this.value};r.addEventListener("change",n),O.push({input:r,handler:n})}),Ze(),Ke()})}document.addEventListener("openProductModal",function(e){const t=e.detail.productId;D(t)});K&&K.addEventListener("click",function(e){return c(this,null,function*(){if(e.target.matches("img, button")){const t=e.target.closest(".product-item");if(t){const s=t.getAttribute("data-id");yield D(s)}}})});const G=document.querySelector(".popular-products-swiper");G&&G.addEventListener("click",function(e){return c(this,null,function*(){if(e.target.matches("img.img-card, button.btn-go-modal")){const t=e.target.closest(".popular-products-item");if(t){const s=t.getAttribute("data-id");yield D(s)}}})});function Xe(e){return`
